  ...
  const { darkMode } = useTheme();
    return (
        <section className={`editing ${darkMode ? 'dark' : ''}`}>
            ...
            <img className="editing__img" src="https://res.cloudinary.com/dfbuwtl5q/image/upload/v1702415354/Jay%20Cowit/IMG_0203_p3c13d.jpg" alt="Jay Cowit in the studio behind a microphone" />
